  ...
  return (
    <div className="flex flex-col justify-start items-center">
      ...
      <section className="grid text-black relative top-[3.1rem] h-screen w-full order-2 bg-[#fafafa]">
        ...
        <div className="sm:w-[60%] min-w-[35rem] sm:left-[12%] md:left-[20%] flex justify-center items-start w-full relative p-5">
          {children}
        </div>
        <div className=" hidden lg:flex  w-[20%] h-full fixed right-0 top-[3.1rem] p-5">
          <RightSider />
        </div>
      </section>
    </div>
